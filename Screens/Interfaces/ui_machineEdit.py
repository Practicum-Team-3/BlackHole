...
class Ui_MachineEdit(object):
    def setupUi(self, MachineEdit):
        ...
        self.browse1.setGeometry(QRect(310, 125, 87, 32))
        self.mname = QLabel(MachineEdit)
        self.mname.setObjectName(u"mname")
        self.mname.setGeometry(QRect(10, 10, 94, 16))
        self.machineName = QLineEdit(MachineEdit)
        self.machineName.setObjectName(u"machineName")
        self.machineName.setGeometry(QRect(100, 10, 291, 20))
        self.label_2 = QLabel(MachineEdit)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 50, 47, 13))
        self.type = QComboBox(MachineEdit)
        self.type.addItem("")
        self.type.addItem("")
        self.type.setObjectName(u"type")
        self.type.setGeometry(QRect(40, 42, 103, 32))
        ...
        self.b1.setGeometry(QRect(270, 42, 126, 32))
        ...
        self.browse2.setGeometry(QRect(310, 165, 87, 32))
        ...
        self.syssets.setGeometry(QRect(120, 340, 141, 32))
        ...
        self.save.setGeometry(QRect(50, 420, 72, 32))
        self.discard = QPushButton(MachineEdit)
        self.discard.setObjectName(u"discard")
        self.discard.setGeometry(QRect(260, 420, 89, 32))
    ...
    def retranslateUi(self, MachineEdit):
        ...
        self.label_2.setText(QCoreApplication.translate("MachineEdit", u"Type:", None))
        self.type.setItemText(0, QCoreApplication.translate("MachineEdit", u"POV Entry", None))
        self.type.setItemText(1, QCoreApplication.translate("MachineEdit", u"Attacker", None))
        ...
        self.software.setText(QCoreApplication.translate("MachineEdit", u"Software:", None))
