...
class BHWelcomeScreen(QDialog):
    ...
    def __init__(self, scenarios):
        ...
        for scenario in scenarios.getScenarios():
            ...
            print("Name: "+scenario.getName())
            print("ID: "+scenario.getId())
            print("Desc: "+scenario.getDescription())
        ...
        self.ui.btnOpen.clicked.connect(self.openScenarioButtonClicked)
    ...
    @Slot()
    def openScenarioButtonClicked(self):
        self.openScenarioRequested.emit(self.scenarios.getScenarioNamesList()[0])
